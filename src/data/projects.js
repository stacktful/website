...
const projects = [
  {
    title: <>Dashwise&reg;</>,
    description: `Cloud-native multi-tenant web application (SaaS) presenting real-time financial \
  ...
  },
  {
    ...
    description: `AI-driven multiple camera system for automated video registration of lectures, \
